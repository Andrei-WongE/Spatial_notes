...
```
Population data is in geodetic CRS, we need to transform this data to Projected CRS. More details about the diffence between these systems [here](https://www.earthdatascience.org/courses/use-data-open-source-python/intro-vector-data-python/spatial-data-vector-shapefiles/geographic-vs-projected-coordinate-reference-systems-python/).
