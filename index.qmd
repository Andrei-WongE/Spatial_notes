...
{\underbrace{%
\vphantom{\begin{bmatrix} x & y \end{bmatrix}}_{\mathclap{\text{Coordinates}}}} \times 
{\underbrace{%
\begin{bmatrix} 1 & 0 \\ 1.2 & 1 \end{bmatrix}}_{(1)}} \times 
{\underbrace{%
\begin{bmatrix} \cos(\pi/20) & \sin(\pi/20)\\-\sin(\pi/20) & \cos(\pi/20) \end{bmatrix}}_{(2)}} +
{\underbrace{%
\vphantom{\begin{bmatrix} x\_add & y\_add \end{bmatrix}}_{\mathclap{(3)}}}}
$$
