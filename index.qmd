...
[For more information about `OpenStreetMap` see http://blog.fellstat.com/?cat=15].{.aside}
...
Lima_multipolygons <- Lima_multipolygons |> 
...
Searh for feature in the following table.
...
roads_sf <- roads_sf |>
  dplyr::filter(st_is_type(geometry, c("LINESTRING"))) # assure only line geometry
...
# Visualize data with sfmap, ggplot2, ggmap and leaflet
